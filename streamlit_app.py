...
# Regression Analysis
    ...
    if input_method == "Single Input":
        ...
        medinc = st.slider('MedInc', 0.0, 15.0, 3.0)
        houseage = st.slider('HouseAge', 0.0, 52.0, 15.0)
        ave_rooms = st.slider('AveRooms', 0.0, 10.0, 5.0)
        ave_bedrms = st.slider('AveBedrms', 0.0, 10.0, 1.0)
        population = st.slider('Population', 0.0, 35000.0, 1500.0)
        ave_occup = st.slider('AveOccup', 0.0, 50.0, 3.0)
